...
PKGDATADIR = os.environ.get("OVS_PKGDATADIR", """/home/ranga/opt/ovs/share/openvswitch""")
RUNDIR = os.environ.get("OVS_RUNDIR", """/home/ranga/opt/ovs/var/run/openvswitch""")
LOGDIR = os.environ.get("OVS_LOGDIR", """/home/ranga/opt/ovs/var/log/openvswitch""")
BINDIR = os.environ.get("OVS_BINDIR", """/home/ranga/opt/ovs/bin""")
...
if not DBDIR:
    ...
    if sysconfdir:
        ...
        DBDIR = """/home/ranga/opt/ovs/etc/openvswitch"""
